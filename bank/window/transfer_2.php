...
<div class="main_box" style="box-shadow: none;">
    ...
    <form name="transfer_ac" id="transfer_ac" method="post" action="./">
        <input type="text" value="between_ac" name="action" hidden>
            ...
            <div class="container_horizontal" style="height: 45px; background: rgb(243,243,244); box-shadow:  8px 8px 17px #d5d5d5, -8px -8px 17px #d5d5d5; border-radius: 5px; margin-top: 20px; align-items: center;">
                <table border="0" style="border-collapse: collapse; width: 100%; height: 100%;">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="from_memo" class="memo" style="padding-right: 15px;" maxlength="10" value="<?=$_SESSION['name']?>">
                        </td>
                    </tr>
                </table>
            </div>
            <div class="container_horizontal" style="height: 45px; background: rgb(243,243,244); box-shadow:  8px 8px 17px #d5d5d5, -8px -8px 17px #d5d5d5; border-radius: 5px; margin-top: 15px; align-items: center;">
                <table border="0" style="border-collapse: collapse; width: 100%; height: 100%;">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="to_memo" class="memo" style="padding-right: 15px;" maxlength="10" value="<?=$_SESSION['name']?>">
                        </td>
                    </tr>
                </table>
            </div>
            <div class="container_horizontal" style="height: 50px; margin-top: 115px;">
