...
<style>
    ...
    .ac_left{
        width: 120px; font-size: 14px; font-weight: 800;
        letter-spacing: 0;
        /*background: #d4fa82;*/
    }

    .ac_right{
        width: 100%; height: auto; font-size: 12px; font-weight: 800; letter-spacing: 1px;
    }
        ...
        <div class="ac_container_horizontal" style="height: auto;">
            <div class="ac_list">
                ...
                <div class="account" style="width: 100%; height: 35px;">
                    ...
                    <div class="ac_num_container">
                        <div class="ac_right">
                            <?=number_format($product['price'][$product['product_key'][$_GET['code']]],2)?>%(연,세전)
                        </div>
                    </div>
                </div>
                <div class="account" style="width: 100%; height: 35px;">
                ...
                <div class="account" style="width: 100%; height: 35px;">
                    <div class="ac_num_container">
                        <div class="ac_right">
                            ** 예적금신규에는 신용한도를 사용할 수 없습니다
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="ac_container_horizontal" style="height: 50px; margin-top: 185px;">
            <form name="ac_open" method="post" action="./">
                <input name="action" value="open_savings" hidden>
