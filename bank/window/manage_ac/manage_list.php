...
<div class="main_box" style="box-shadow: none;">
    ...
    <div class="ac_container_vertical" style="margin-top: 120px">
        <div class="ac_container_horizontal" style="height: 600px;">
            <div class="ac_list">
                <div class="account" style="width: 100%; height: 50px;">
                    ...
                    <div class="ac_num_container">
                        <div style="width: 100%; height: auto; font-size: 15px; font-weight: 800; letter-spacing: 2px;">
                            이체한도관리
                        </div>
                    </div>
                </div>
                <div class="account" style="width: 100%; height: 50px;">
                    <div style="width: 100px;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-credit-card-2-front svg_btn" viewBox="0 0 16 16">
                ...
                <div class="account" style="width: 100%; height: 50px;">
                    <div style="width: 100px;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-card-heading svg_btn" viewBox="0 0 16 16">
                            <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                            <path d="M3 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0-5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-1z"/>
                        </svg>
                    </div>
                    <div class="ac_num_container">
                        <div style="width: 100%; height: auto; font-size: 15px; font-weight: 800; letter-spacing: 3px;">
                            해지계좌 거래내역 조회
                        </div>
                    </div>
                </div>
                <div class="account" style="width: 100%; height: 50px;">
                    <div style="width: 100px;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-x-lg svg_btn" viewBox="0 0 16 16">
