...
<div class="main_box" style="box-shadow: none;">
    ...
    <form name="transfer_ac" id="transfer_ac" method="post" action="./">
        <div class="container_vertical">
                ...
                <div class="select-box">
                    <div class="select-box__current" tabindex="1">
                        ...
                        <div class="select-box__value">
                            <input type="text" value="transfer_1" name="action" hidden>
            ...
            <div class="container_horizontal" style="height: 45px; background: rgb(243,243,244); box-shadow:  8px 8px 17px #d5d5d5, -8px -8px 17px #d5d5d5; border-radius: 5px;">
                <input type="text" name="to_ac" class="transfer_to" style="" maxlength="14" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="입금할 계좌번호">
            </div>
            ...
            <div class="container_horizontal" style="height: 50px; margin-top: 205px;">
