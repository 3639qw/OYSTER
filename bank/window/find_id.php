...
<script>
    function Check(){
        ...
        // 신분확인번호 검증
        if($("input[name=pid]").val() == '' || $("input[name=pid]").val() == null){
...
<div class="login_box" style="box-shadow: none;">
    <div class="logo"></div>
    <div class="title" style="font-weight: 800;">아이디 찾기</div>

    <form name="signin_form" id="signin_form" method="post" action="../bank/login/search_action.php">
        <div class="fields">
            <div class="username">
            ...
            <div class="password">
                ...
                <input type="password" class="pass-input" name="pid" placeholder="신분확인번호" maxlength="13" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
            </div>
        </div>
        <button onclick="return Check()" class="signin_button">아이디 찾기</button>
    </form>
    <div class="link">
        <a href="/bank">로그인</a>
    </div>
