...
<?php
    ...
    $initial = $_POST['initial']; // 학교 이니셜

	$sql = "INSERT INTO high_sch (name, initial, founder, est, type, gender, zip, addr1, addr2, office_edu)";
	$sql.="VALUES('$name', '$initial', '$founder', '$est', '$type','$gender','$zip','$addr1','$addr2','$office_edu')";
