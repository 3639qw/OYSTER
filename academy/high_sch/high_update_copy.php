...
<html>
    ...
    <body>
        ...
        <div id="post" style="width: 500px;">
            ...
            <form name="high_insert" action="update_action.php" method='post'>
                        <table border="0" align="center">
                            <tr>
                                <td width="80">
                                    학교명: <input type="text" class="form-02" size="30" name="name"> 
                            ...
                            <tr>
                                <td rowspan="4">
                                    <table border="0">
                                        <tr>
                                            <td align="left">
                                                우편번호 : <input type="text" class="form-02" name="zip" style="width:80px; height:26px;">
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td colspan="2" width="150px">
                                                주소 <input type="text" class="form-02" name="addr1" style="width:300px; height:30px;" readonly><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
        ...
        <script>
            document.high_insert.office_edu.value="<?php echo $row['office_edu']?>"
            document.high_insert.name.value="<?php echo $row['name']?>"
            document.high_insert.est.value="<?php echo $row['est']?>"
            document.high_insert.founder.value="<?php echo $row['founder']?>"
            document.high_insert.gender.value="<?php echo $row['gender']?>"
            document.high_insert.type.value="<?php echo $row['type']?>"
            document.high_insert.zip.value="<?php echo $row['zip']?>"
            document.high_insert.addr1.value="<?php echo $row['addr1']?>"
            document.high_insert.addr2.value="<?php echo $row['addr2']?>"
