...
<div style="height: 150px; width: 1800px; margin-left: 30px; margin-top: 30px; float: left;">
    ...
    <div class="box insert_box" style="height: 100%; width: 1200px; float: left;">
        <form name="mid_insert" action="insert_action.php" method="post" id="mid_insert">
            <table border="0" align="center">
                <tr>
                    <td>
                        학교명 : <input type="text" class="form_field" size="20" id="name" name="name">
                        <p>설립유형 : <select class="form_field" name="founder">
                    ...
                    <td align="left" style="padding-left: 70px; padding-right: 50px;">
                        ...
                        <p>
                            설립일 : <input type="date" class="form_field" value="2021-01-01" min="1900-01-01" max="2099-12-31" name="est">
                    ...
                    <td style="padding-left: 30px;">
                        <button type="submit" form="mid_insert" class="button" style="width: 80px; height: 80px; font-size: 11px;" onclick="return check_insert()">입력하기</button>
                    </td>
    ...
    <!-- 작성 규칙 -->
    <div class="box" style="height: 150px; width: 400px; float: left; margin-left: 20px;">
        <table border="0" align="center">
            <tr align="center">
                <td>
                    작성 규칙
    ...
    <div style="height: 50px; width: 1200px; margin-top: 20px; float: left;">
        <div class="box" style="height: 100%; width: 69%; float: left;">
            <table border="0">
                <tr>
                    <td>
                        <form action="index.php" method="post" id="searchMid">
                            <?php
                            $office = $_POST['office'];
                            ?>
                            관할 교육청: <select style="margin-left: 5px;" class="form_field" name="office">
                                <option value="">교육청 선택</option>
                                <?php
                                $office_name_sql="select office_edu from mid_sch group by office_edu order by office_edu asc;";
                            ...
                            <button type="submit" form="searchMid" class="button" style="margin-left: 10px; display: inline; width: 90px; height: 30px;">입력하기</button>
                        </form>
                    </td>
                </tr>
            </table>
        ...
        <table border="0" align="center" style="width: 99%;">
            ...
            while($row = mysqli_fetch_array($result))
            {
                ...
                <tr align='center'>
                    ...
                    <td width='5%'><a href='mid_update.php?id=$id'>[수정]</a></td>
                </tr>
                ");
                $count++;
            }
