    ...
    <div id="post">
            <div id="pnav">
              ...
              <img class="pbuttons" src="../mini.png">
                ...
                <form name="mid_insert" action="insert_action.php" method='post'>
                    <table border="0" align="center" width="895px">
                        <tr>
                            <td width="180px">
                            
                                    학교명 : <input type="text" class="form-02" size="16" id="name" name="name" id="name">  
        ...
        <div id="post">
            ...
            <table border=1" align="center" id="show" style="margin: 2px 4px 0px 2px; ">
                ...
                <?php
                if($_GET['mode'] == "office"){
                    $sql = "select * from mid_sch order by office_edu;";
                }else if($_GET['mode'] == "founder"){
                    $sql = "select * from mid_sch order by founder;";
                }
                else{
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    <td><a href='mid_update.php?id=$id'>[수정]</a></td>
