...
$sql = "select * from korean_sat where id = '$id';";
...
<body>
                ...
                <form name="score_insert" action="update_action.php" method="post" id="stu_score">
                    <table border="0" align="center" style="border-collapse: collapse;" width="330">
                        <tr align="left" style="height: 60px;">
                            <td>
                                번호 : <input type="text" style="border: none; background: transparent;" size="7" name="id" id="id" readonly>    
                            </td>
                            <td>
                        ...
                        <tr align="left" style="width: 100%; height: 50px;">
                            <td>
                                <button type="button" class="button" onclick="location.href='/academy/sat'" style="width: 45%; height: 40px; float: left; font-size: 12px;">뒤로<br>가기</button>
                                <button type="button" class="button" onclick="location.href='score_delete.php?id=<?php echo $id ?>'" style="width: 45%; height: 40px; float: right; font-size: 13px;">삭제</button>
                            </td>
    ...
    <script>
        document.score_insert.id.value="<?php echo $row['id']?>"
        document.score_insert.kor.value="<?php echo $row['kor']?>"
        document.score_insert.math.value="<?php echo $row['math']?>"
        document.score_insert.eng.value="<?php echo $row['eng']?>"
        document.score_insert.kor_history.value="<?php echo $row['kor_history']?>"
